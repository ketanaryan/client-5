    ...
    <div className="flex-1 space-y-6 p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-slate-500">Firm performance, revenue tracking, and operational efficiency.</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent className="pl-2 h-[300px] flex items-center justify-center border-t border-slate-100 bg-slate-50/50">
